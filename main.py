from PyQt6.QtWidgets import (
    ...
    QCheckBox, QMessageBox, QDialog, QFormLayout, QDialogButtonBox, QWidget, QGridLayout
)
...
def add_user(username, password, building_number, is_admin=False):
    print(f"Adding user: username={username}, password={password}, building_number={building_number}, is_admin={is_admin}")  # Debugging
    try:
...
class RegisterDialog(QDialog):
    ...
    def register_user(self):
        ...
        print(f"Attempting to register user: username={username}, password={password}, building_number={building_number}, is_admin={is_admin}")  # Debugging
        ...
        print(f"Register result: {result}")  # Debugging
